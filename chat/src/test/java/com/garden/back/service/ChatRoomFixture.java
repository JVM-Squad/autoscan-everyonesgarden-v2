...
public class ChatRoomFixture {
    ...
    public static GardenChatMessage partnerFirstGardenChatMessage(
        Long chatMessageId,
        GardenChatRoom gardenChatRoom) {
    ...
    public static GardenChatMessage partnerSecondGardenChatMessage(
        Long chatMessageId,
        GardenChatRoom gardenChatRoom) {
        return GardenChatMessage.of(
            chatMessageId,
